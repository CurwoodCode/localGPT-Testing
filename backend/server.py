...
Respond with exactly one word: USE_RAG or DIRECT_LLM"""
        ...
        try:
            ...
            response = self.ollama_client.chat(
                ...
                model="qwen3.5:0.8b",  # Fast model for routing
    ...
    def _handle_direct_llm_query(self, session_id: str, message: str, session: dict):
        ...
        try:
            ...
            model = session.get('model', 'qwen3.5:9b')  # Default to fast model
        ...
        try:
            ...
            if RAG_SYSTEM_AVAILABLE and PIPELINE_CONFIGS.get('default'):
                ...
                complete_metadata = {
                    ...
                    'enrich_model': 'qwen3.5:0.8b',  # From default config
                    'overview_model': 'qwen3.5:0.8b',  # From default config
